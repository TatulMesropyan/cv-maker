...
const Createform = () => {
  ...
  // useEffect(() => {
  //   if (!mainUserData.email.includes("!")) {
  //     setError({ email: "Please enter valid email!" });
  //   }
  //   if (!/[0-9]/.test(mainUserData.phone)) {
  //     setError({ phone: "Please enter valid phone" });
  //   }
  //   if (
  //     !/[0-9]/.test(education.earlyYear) ||
  //     !/[0-9]/.test(education.lateYear)
  //   ) {
  //     setError({ educationYears: "Please enter valid Years" });
  //   }
  // }, [mainUserData, education]);
  ...
  return (
    <UserContext.Provider value={{mainUserData,education,project,summary,skills,workExperience,language,certificate}}>
